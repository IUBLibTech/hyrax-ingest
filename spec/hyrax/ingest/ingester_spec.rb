  ...
  describe '.factory' do
    context 'when given "ActiveFedoraBase" as an argument' do
      it 'returns an instance of Hyrax::Ingest::Ingester::ActiveFedoraBaseIngester' do
        ...
        expect(described_class.factory("ActiveFedoraBase", example_sip, options)).to be_a Hyrax::Ingest::Ingester::ActiveFedoraBaseIngester
      end
    end

    context 'when given "FileSet" as an argument' do
      it 'returns an instance of Hyrax::Ingest::Ingester::FileSetIngester' do
        expect(described_class.factory("FileSet", example_sip)).to be_a Hyrax::Ingest::Ingester::FileSetIngester
      end
    end

    context 'when given "Work" as an argument' do
      it 'returns an instance of Hyrax::Ingest::Ingester::WorkIngester' do
        expect(described_class.factory("Work", example_sip)).to be_a Hyrax::Ingest::Ingester::WorkIngester
      end
    end

    context 'when given "WorkIngester" as an argument' do
      it 'returns an instance of Hyrax::Ingest::Ingester::WorkIngester' do
        expect(described_class.factory("WorkIngester", example_sip)).to be_a Hyrax::Ingest::Ingester::WorkIngester
      end
    end

    context 'when given "ThisDoesNotExist" as an argument' do
      it 'raises a Hyrax::Ingest::Errors::UnknownIngesterClass error' do
        expect { described_class.factory("ThisDoesNotExist", example_sip) }.to raise_error Hyrax::Ingest::Errors::UnknownIngesterClass
      end
    end
    ...
    context 'when given an ambiguous argument that matches more than one Ingester class' do
      ...
      it 'raises a Hyrax::Ingest::Errors::AmbiguousIngesterClass error' do
        expect { described_class.factory("WorkIngester", example_sip) }.to raise_error Hyrax::Ingest::Errors::AmbiguousIngesterClass
      end
